...
<p align="center">
  <img src="./readme/chat-tool-usage.png" alt="Chat with the agent building a small project via tool calls" width="720">
</p>
<p align="center"><em>Asked for a small multi-file site — the agent scaffolds it by actually calling <code>storage.create_directory</code>/<code>storage.write_file</code>, with its reasoning shown (collapsed) above each call.</em></p>
...
- A few themes to pick from (dark / white / matcha-dark) — will expand in the future!

## Screenshots
| | | |
|:---:|:---:|:---:|
| <img src="./readme/home-screen.png" width="260"><br><sub>Home — a fresh chat starts with a generated greeting, ready to type.</sub> | <img src="./readme/settings-page.png" width="260"><br><sub>Settings — name, timezone, theme picker, and a live preview of every themed component.</sub> | <img src="./readme/tool-permission-prompt.png" width="260"><br><sub>Permission prompt — a dangerous call (deleting a folder here) always stops and asks first.</sub> |
...
## Docs
- [`backend/README.md`](./backend/README.md) + [`backend/TOOLS.md`](./backend/TOOLS.md) — the Rust backend, and how the tool system works.
